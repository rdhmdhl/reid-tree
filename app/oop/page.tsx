    ...
    <div className="container">
      ...
      <ContentCard>
        ...
        <p className="mt-2">
          ...
          (accelerator and brake pedals), but they don't need to know its inner
          workings to do so.{" "}
        </p>
        <p className="mt-2">
          ...
          or methods are called a "subclass", while the class that passes down
          its properties or methods is called a "superclass". A car body has
          multiple properties that it can pass down to its fenders, hood,
          trunklid, such as sheet metal material, primer, paint and clear coat.
        </p>
        <p className="mt-2">
          ...
          does not matter; the driver's license provides a consistent way to
          interact with any vehicle.{" "}
        </p>
      </ContentCard>
      <ContentCard>
        ...
        <p className="mt-2">
          ...
          behaviors. Each object is an instance of a class in the computer's
          memory. Creating an object from a class is called "instantiation".
        </p>
        <p className="mt-2">
